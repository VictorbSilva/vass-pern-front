...
function Contatos() {
    return (
        <div className='ContatosWrapper max-w-full mx-auto space-y-8 pb-8'>
            <div
                className='ContactContainer w-full min-h-[45vh] bg-gradient-to-br from-blue-800 to-cyan-500 px-8 md:px-16 py-12 rounded-lg shadow-xl'>
        <span
            className='bg-white/10 text-white/90 text-xs md:text-sm font-bold px-4 py-1.5 rounded-full mb-6 tracking-wide border border-white/20'>
          ATENDIMENTO DIRETO
        </span>
            ...
            <div className='CardsContainer grid grid-cols-1 lg:grid-cols-2 gap-8 px-2 md:px-8'>
                <div
                    className='InfoCard bg-white flex flex-col justify-center gap-8 p-8 rounded-3xl shadow-sm border border-gray-100'>
                    <div className='flex items-center gap-4'>
                        <div
                            className='w-12 h-12 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center shrink-0'>
                ...
                <div
                    className='WhatsAppCard bg-white flex flex-col justify-center p-8 rounded-3xl shadow-sm border border-gray-100'>
                    <div
                        className='w-14 h-14 bg-green-50 text-green-500 rounded-2xl flex items-center justify-center mb-6'>
